...
short_desc: 'Welcome event for facsters',
 venue: 'Fac HQ', location: 'Palmers Road', 
 event_date: '03/10/2017', 
 tkts_available: 5 }, 
 { title: 'Fac End', short_desc: 'Leaving event for facsters',
  venue: 'Fac HQ', location: 'Palmers Road', event_date: '03/10/2017',
   tkts_available: 3 }, { title: 'beiber', short_desc: 'concert',
    venue: 'Fac HQ', location: 'Palmers Road', event_date: '03/10/2017',
     tkts_available: 4 }, { title: 'Haloween', short_desc: 'party', 
     venue: 'Fac HQ', location: 'Palmers Road', event_date: '03/10/2017',
      tkts_available: 3 } ]
