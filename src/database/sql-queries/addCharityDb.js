...
module.exports = (body) => {
  const {charityName, charityNumber, areaOfWork, charityAddress, contactName, contactSurname, contactEmail, contactNumber, password, randomstring, emailVerifyString} = body
